...
?>
    ...
    <div class="alert alert-primary">
        <h4>Cetak Log System</h4>
    </div>

<div class="container rounded" style="background-color: #d6eaf8; padding-top:30px;">
<form method="POST" action="cetak-log.php" onsubmit="return validasiCetakLog()" target="_blank">
...
<tr>
    <td><button type="submit" class="btn btn-success" id="submit" name="submit"><i class="fas fa-print"></i> Cetak Log</button></td>
    <td><a class="btn btn-warning" href="?page=lihat-log">Cancel</a></td>
</tr>
</table>
  </div>
