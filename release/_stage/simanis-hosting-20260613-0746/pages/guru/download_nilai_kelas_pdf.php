...
function dnk_table_exists(mysqli $conn, string $table): bool
{
...
function dnk_column_exists(mysqli $conn, string $table, string $column): bool
{
    $tableEsc = mysqli_real_escape_string($conn, $table);
...
if (!$canAccess && dnk_table_exists($conn, 'tbl_wali_kelas') && dnk_table_exists($conn, 'tbl_kelas')) {
...
if (!$canAccess && dnk_table_exists($conn, 'tbl_kelas') && dnk_column_exists($conn, 'tbl_kelas', 'nip_wali')) {
