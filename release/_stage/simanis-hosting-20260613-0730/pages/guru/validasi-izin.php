...
$title = 'Fitur Guru';
$dashboardUrl = php_sapi_name() === 'cli-server' ? 'guru_legacy.php' : 'guru_legacy';
?>
<!doctype html>
<html lang="id">
<head>
...
<body class="bg-light">
    <main class="container py-5">
        <div class="bg-white border rounded-3 p-4 shadow-sm">
            ...
            <a href="<?= htmlspecialchars($dashboardUrl, ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary">Kembali ke Dashboard</a>
        </div>
    </main>
