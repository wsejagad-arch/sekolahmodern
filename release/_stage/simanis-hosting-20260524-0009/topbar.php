...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
  ...
  <ul class="navbar-nav ml-auto align-items-center">
    ...
    <li class="nav-item dropdown no-arrow">
      <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: 6px 10px !important;">
      ...
      <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown" style="min-width:220px; border:none; border-radius:12px; box-shadow:0 8px 32px rgba(26,60,110,0.15); overflow:hidden; padding:8px 0;">
        ...
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal" style="padding:10px 18px; font-size:13.5px; font-weight:500; color:#dc2626; display:flex; align-items:center; gap:10px; transition:all .2s;">
