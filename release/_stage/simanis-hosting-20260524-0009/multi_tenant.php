...
function mt_add_school_column(mysqli $conn, string $table, string $after = ''): void
{
...
function mt_ensure_insert_trigger(mysqli $conn, string $table): void
{
    if (!mt_table_exists($conn, $table) || !mt_column_exists($conn, $table, 'id_sekolah')) {
        return;
    }
...
function mt_ensure_schema(mysqli $conn): void
{
    static $done = false;
    if ($done) {
        return;
...
function mt_bootstrap(?mysqli $conn): void
{
...
function mt_apply_connection_school(mysqli $conn): void
{
...
function mt_refresh_session_school(mysqli $conn): void
{
