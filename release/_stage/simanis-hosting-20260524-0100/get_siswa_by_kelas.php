...
// Start session so endpoint can read authentication info
...
try {
    ...
    // PHP 7.0 compatibility: use bind_result instead of get_result
    mysqli_stmt_bind_result($stmt, $no_induk, $nama);
