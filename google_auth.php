...
function google_oauth_error_redirect(string $reason, string $kode = '')
{
...
function google_oauth_start(string $schoolCode)
{
...
function google_find_user_by_email(mysqli $conn, string $email, int $schoolId)
{
