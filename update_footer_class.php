...
<nav class="siswa-footer-nav">
  <a href="siswa.php" class="sfooter-item <?= $currentPage == \'siswa.php\' ? \'active\' : \'\' ?>">
    <i class="fas fa-home"></i>
    <span class="sfooter-label">Beranda</span>
  </a>
  <a href="presensi.php" class="sfooter-item floating <?= $currentPage == \'presensi.php\' ? \'active\' : \'\' ?>">
    <div class="icon-wrapper">
      <i class="fas fa-fingerprint"></i>
    </div>
    <span class="sfooter-label">Presensi</span>
  </a>
  <a href="profil.php" class="sfooter-item <?= $currentPage == \'profil.php\' ? \'active\' : \'\' ?>">
...
echo "Updated siswa_footer.php to use unique classes.";
?>
