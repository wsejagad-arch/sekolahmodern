...
<main class="page-shell">
    <section class="hero mb-3">
        <a href="<?= htmlspecialchars(leger_page_route('guru_2026'), ENT_QUOTES, 'UTF-8'); ?>" class="text-white-50 text-decoration-none"><i class="bi bi-arrow-left"></i> Kembali ke Beranda</a>
