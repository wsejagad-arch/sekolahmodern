...
$result = $conn->query("SELECT g.*, m.nama_mapel 
                         ...
                         ORDER BY 
                            CASE WHEN m.nama_mapel = 'Kepala Sekolah' THEN 0 ELSE 1 END,
                            m.nama_mapel ASC, 
                            g.nama_guru ASC");
...
// Grouping guru by mapel
$grouped_teachers = [];
while($row = $result->fetch_assoc()) {
    $mapel = $row['nama_mapel'] ?: 'Umum';
    $grouped_teachers[$mapel][] = $row;
}
?>
<!DOCTYPE html>
<html lang="id">
                        ...
                        <?php foreach($teachers as $row): ?>
                            <div class="teacher-card">
                                ...
                                <div class="teacher-info">
                                    ...
                                    <span class="teacher-subject"><?= htmlspecialchars($row['nama_mapel'] ?: 'Umum') ?></span>
