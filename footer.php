...
<?php
if (isset($GLOBALS['custom_modals'])) {
    echo $GLOBALS['custom_modals'];
}
?>
...
<script src="<?= asset_url('vendor/datatables/dataTables.responsive.min.js'); ?>"></script>
...
<!-- Script Auto-Responsive Tables on Mobile -->
