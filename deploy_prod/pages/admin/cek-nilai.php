...
// Dropdown data
$kelasOpts = mysqli_query($conn, "SELECT DISTINCT kelas FROM tbl_mapel_ampu ORDER BY kelas ASC");
$mapelOpts = mysqli_query($conn, "SELECT DISTINCT id_mapel, nama_mapel, kelas FROM tbl_mapel_ampu ORDER BY nama_mapel ASC, kelas ASC");
...
<div class="container-fluid">
  ...
  <?php while ($p = mysqli_fetch_assoc($pertemuan)) {
    ...
    $siswa = mysqli_query($conn, "SELECT no_induk, nama_siswa FROM tbl_siswa WHERE kelas='".mysqli_real_escape_string($conn,$kls)."' AND status='Aktif' ORDER BY nama_siswa ASC");
