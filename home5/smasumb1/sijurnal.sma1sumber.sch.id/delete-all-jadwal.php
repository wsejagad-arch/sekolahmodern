...
<?php	
		...
		<script>
			if (typeof showToast === 'function') {
				...
				setTimeout(function(){ window.location = "home.php?page=detail-guru&id=<?= $idguru; ?>&no_induk=<?= $noinduk; ?>"; }, 1400);
			} else {
				alert('Gagal menghapus jadwal!');
				window.location = "home.php?page=detail-guru&id=<?= $idguru; ?>&no_induk=<?= $noinduk; ?>";
			}
		</script>
<?php   
}
